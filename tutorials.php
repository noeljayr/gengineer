...
<html lang="en">
  <head>
    ...
    <title>Girl Engineer - Tutorials</title>
  ...
  <body>
    ...
    <script>
      ...
      const videos = [
        {
          id: 1,
          title: "Animating Name Tutorial",
          thumbnail: "Animating Name Tutorial Thumbnail.jpg",
           src: "Animating Name Tutorial.mp4",
          page: "tutorials",
        },
        {
          id: 2,
          title: "Animating a Simple Car Tutorial",
          thumbnail: "Animating a Simple Car Tutorial Thumbnail.jpg",
          src: "Animating a Simple Car Tutorial.mp4",
          page: "tutorials",
        },
        {
          id: 3,
          title: "Electric Propeller Car Tutorial",
          thumbnail: "Electric Propeller Car Tutorial Thumbnail.jpg",
          src: "Electric Propeller Car Tutorial.mp4",
          page: "tutorials",
        },
        {
          id: 4,
          title: "Coding a Simple Web Page Tutorial",
          thumbnail: "Coding a Simple Web Page Tutorial Thumbnail.jpg",
          src: "Coding a Simple Web Page Tutorial.mp4",
          page: "tutorials",
        },
      ];
      ...
      function showVideos(vid) {
        ...
        video.href = `player.html?viewId=${vid.id}`;
        video.innerHTML = `
          ...
          <img
            src="./public/tutorials/tutorials/thumbnails/${vid.thumbnail}"
            alt="${vid.title}"
            class="thumbnail"
          />
