<?php
  include 'includes/loadVolunteers.php';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Girl Engineer - Our Volunteers</title>
  ...
  <body>
    ...
    <?php
        ...
        ";
        for ( $i  = 0 ; $i <  count( $volunteerResults ); $i ++ )
        {
          echo   "
          <script>
          
          obj = {
            id:   '".$volunteerResults[$i]['user_id']  ."',
            name:  '".$volunteerResults[$i]['name']  ."'  ,
            position:  '".$volunteerResults[$i]['position']  ." ',
            image:  '".$volunteerResults[$i]['picture']  ." '
          };    
      ...
      function displayVolunteers() {
        volunteers.forEach((m) => {
          ...
          <div class="member-img">
            ...
            <img
              loading="lazy"
              src="public/images/volunteers/` +m.image +  `"
              alt="` +
            m.name +
            `"
            />
